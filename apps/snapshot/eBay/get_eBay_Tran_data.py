# ==============================================================================
# eBay トランザクション履歴データ取得スクリプト
#
# 【処理概要】
# eBay Finances API（/sell/finances/v1/transaction）を使用して、
# 指定アカウントの取引履歴（売上・返金・手数料など）を全件取得する。
#
# 【データ取得元】
...
#
# 【出力内容】
# 取引日・タイプ・オーダーID・購入者・総額・手数料内訳（落札/固定/海外）・純額をCSV出力
# 出力先: \\MOUSE\apps_nostock\apps\snapshot\eBay\transaction\eBay_Transactions_{account}.csv
#
# 【対象アカウント】
