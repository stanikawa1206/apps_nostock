# ============================================================
# update_category_groups_and_presets_price_ranges_new.py
#
# ■ 目的
...
#    nostock.mst.presets_price_ranges_new の全行について、
...
SELECT
    ...
    low_usd_target,
    high_usd_target
FROM nostock.mst.presets_price_ranges_new
WHERE category_group = ?
ORDER BY preset_group
"""

SQL_UPDATE_PRESETS_JPY = """
UPDATE nostock.mst.presets_price_ranges_new
SET
    low_jpy_target  = ?,
    high_jpy_target = ?
WHERE category_group = ?
...
def main():
    ...
    for row in category_rows:
        ...
        # ===== 内側: presets_price_ranges_new（同じcategory_group配下を全部） =====
