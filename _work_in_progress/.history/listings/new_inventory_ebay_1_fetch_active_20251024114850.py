...
MERCARI_BASE_URL = (
    "https://jp.mercari.com/search?"                               # ブランドID（ルイ・ヴィトン）
...
# 出品状態：販売中
MERCARI_BASE_URL =MERCARI_BASE_URL＋     "&status=on_sale"       

URLS = [
    MERCARI_BASE_URL =MERCARI_BASE_URL＋       &item_types=beyond"　,  # メルカリshops
    {
        "name": "コインケース・小銭入れ",
        "preset": "ヴィトン小銭入れMS",
        "vendor_name": "メルカリshops",
        "url": f"{MERCARI_BASE_URL}&category_id=243,
    },


    # MERCARI_BASE_URL =MERCARI_BASE_URL＋       &item_types=mercari"　,  # メルカリ
    # --- 以下、旧URL コメントアウト分 ---
    # {
    #     "name": "コインケース・小銭入れ",
    #     "preset": "ヴィトン小銭入れM",
    ...
    #     "preset": "ヴィトン長財布M",
    #     "vendor_name": "メルカリ",
    #     "url": f"{MERCARI_BASE_URL}&item_types=mercari&category_id=241",
    # },
    # {
    #     "name": "折り財布",
    #     "preset": "ヴィトン折り財布M",
    #     "vendor_name": "メルカリ",
    #     "url": f"{MERCARI_BASE_URL}&item_types=mercari&category_id=242",
    # },
]
